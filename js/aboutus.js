...
imgteam.setAttribute("src","img/Image from iOS.jpg");
...
function showImgstdu2(event){
    event.preventDefault();
imgteam.setAttribute("src","img/__+962 7 8246 3530__ 20210523_144801.jpg");
...
function showImgstdu3(event){
    event.preventDefault();
imgteam.setAttribute("src","img/IMG_20210412_234304.jpg");
...
function showImgstdu4(event){
    event.preventDefault();
imgteam.setAttribute("src","img/IMG_9855.jpg");
...
function showImgstdu5(event){
    event.preventDefault();
imgteam.setAttribute("src","img/TNGRRLUMA-U01TXMV8X7V-24cf038424c3-512.png");
